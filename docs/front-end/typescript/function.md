...
the extra arguments are simply ignored, TypeScript the same way. Functions with fewer
parameters can always take the place of functions
...
/*
The signature of the implementation is not visible from the outside, when writing an 
overloaded function,you should always have two or more signatures above the implementation 
of the function.
*/
